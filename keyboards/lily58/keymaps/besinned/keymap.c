 ...
 * |LCTRL |   Z  |   X  |   C  |   V  |   B  |-------|    |-------|   N  |   M  |   ,  |   .  |   /  |   \  |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | LAlt | LGUI |LOWER | /Space  /       \Enter \  |RAISE |BackSP| ARROW |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
 ...
 [_QWERTY] = LAYOUT( \
  ...
  KC_LCTRL,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_LBRC,  KC_RBRC,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_BSLASH, \
                             KC_LALT, KC_LGUI,MO(_LOWER), KC_SPC,   KC_ENT,   MO(_RAISE),   KC_BSPC, TG(_ARROW) \
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
[_LOWER] = LAYOUT( \
  ...
  _______, _______, _______, _______, _______, _______, _______, _______, KC_EQL, KC_PLUS, KC_MINS, KC_LCBR, KC_RCBR, KC_PIPE, \
...
[_RAISE] = LAYOUT( \
  ...
  _______, _______, _______, _______, _______, _______,  _______, _______, KC_EQL, KC_PLUS, KC_MINS,  KC_LBRC, KC_RBRC, KC_BSLS, \
                             _______, _______, _______,  _______, _______,  _______, KC_DELETE, _______ \
),
/* ADJUST
 * ,-----------------------------------------.                    ,-----------------------------------------.
